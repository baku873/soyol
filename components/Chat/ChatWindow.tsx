        ...
        <div className="flex-1 flex flex-col h-full bg-transparent relative">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
                ...
                {Array.isArray(messages) && messages.map((rawMsg) => {
                    // Cast to extended Message type to allow roomName
                    ...
                    // Retrieve inviteRoomName using content split fallback
                    const inviteRoomName = isInvite
                        ? (msg.roomName || (msg.content?.split(':').pop()?.trim()) || null)
                        : null;
                                ...
                                {isInvite ? (
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <button
                                            ...
                                            disabled={!inviteRoomName || !onJoinCall}
